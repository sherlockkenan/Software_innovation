    ...
    <main>
      ...
      <section title="Work" class="boxedBulletList">
        ...
        <ul>
          ...
          <li><strong>Company</strong>: State University of New York at Stony Brook<ul>
            ...
            <li><strong>Synopsis</strong>: Research and teaching in political science, with concentrations in language policy, social choice theory, and quantitative research methods.</li>
            <li><strong>Highlights</strong>: Presented conference papers/Published book chapters, research articles, and working papers/Visiting appointments at U of Mannheim (Germany), McGill U (Montréal), USSR Academy of Sciences, and Stanford U</li>
          </ul></li>
        </ul>
      </section>
      <section title="Volunteering" class="boxedBulletList">
        ...
        <ul>
          ...
          <li><strong>Organization</strong>: Peace Corps<ul>
            ...
            <li><strong>Highlights</strong>: Taught in middle and high schools in Nevşehir and İstanbul, Turkey/Published articles in a Turkish news magazine (“Yön”) and “Peace Corps Volunteer”/Published a language textbook</li>
          </ul></li>
      ...
      <section title="Languages" class="boxedBulletList">
        ...
        <ul>
          ...
          <li><strong>Name</strong>: Norwegian (Bokmål)<ul>
            <li><strong>Level</strong>: Medium-low</li>
          </ul></li>
        </ul>
      </section>
